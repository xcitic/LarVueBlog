        ...
        <div class="col-md-12" v-else>
            ...
            <section>
                ...
                <div class="comments-list text-left">
                    ...
                    <Comment v-for="(comment, index) in comments" :key="index" :username="comment.user_info.name" :text="comment.text" :image="comment.user_info.image" :createdAt="comment.published" :profile="comment.user_info.profile_link" />
