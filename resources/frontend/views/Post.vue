        ...
        <div class="row mt-1">
            ...
            <div class="col-md-12" v-else>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-center">
                                ...
                                <!--Facebook-->
                                <a href="" target="_blank" class="btn-floating btn-small btn-fb"><i
                                    class="fa fa-facebook"> </i></a>
                                <!--Twitter-->
                                <a href="" target="_blank" class="btn-floating btn-small btn-tw"><i
                                    class="fa fa-twitter"> </i></a>
                                <!--Google +-->
                                <a href="" target="_blank" class="btn-floating btn-small btn-gplus"><i
                ...
                <section class="mb-1">
                    ...
                    <CommentForm v-if="authenticated && user" :userImage="userImage" :postId="post.id"/>

                    <div v-else>
                        <router-link class="btn btn-primary" :to="{ name: 'login', params: {} }">Login</router-link>
                        or
                        <router-link class="btn btn-secondary" :to="{ name: 'register', params: {} }">Register
                        </router-link>
                    </div>
                ...
                <section>
                    ...
                    <div class="comments-list text-left">
                        ...
                        <Comment v-for="(comment, index) in comments" :key="index" :username="comment.user_info.name"
                                 :text="comment.text" :image="comment.user_info.image" :createdAt="comment.published"
