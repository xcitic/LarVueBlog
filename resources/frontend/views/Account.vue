                ...
                <div class="card contact-card">
                    <div class="admin-panel info-admin-panel">
                        ...
                        <div class="card-block text-center">
                            <img v-if="user.image" :src="user.image" alt="User Photo"
                                 class="rounded-circle contact-avatar my-2 mx-auto">
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-secondary waves-light" @click.prevent="showPassword">
                                            Change Password
                                        </button>
                                        <br>
  ...
  export default {
    ...
    methods: {
      ...
      async saveImage(image) {
        // Strip Mime type
        let processedImage = await image.replace(/^data:image\/(png|jpg|jpeg|JPEG|gif);base64,/, "")
        let payload = {
