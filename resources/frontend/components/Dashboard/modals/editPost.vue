        ...
        <section class="section mt-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-r">
                        <div class="card-block">
                            ...
                            <textarea v-model="post.description" type="text"
                                      ...
                                      name="description"
                            ></textarea>
                                <label for="description" :class="post.description ? 'active' : ''" class="ml-1">Short
                                    Description</label>
                    ...
                    <!-- Second card -->
                    <div class="card mb-r">
                        <ckeditor :editor="editor" :config="editorConfig" tag-name="textarea"
                                  v-model="post.content"></ckeditor>
                    </div>
                    <!-- /.Second card -->
                    ...
                    <div class="card card-cascade narrower mb-r">
                        <div class="admin-panel info-admin-panel">
                            ...
                            <div class="card-block text-center">
                                ...
                                <p><i class="fa fa-calendar mr-1" aria-hidden="true"></i> Publish:
